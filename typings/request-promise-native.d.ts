// Type definitions for request-promise-native
  ...
  namespace requestPromise {
    interface RequestPromise extends request.Request {
      ...
      then<TResult>(
        ...
        onrejected?: (reason: errors.RequestError) => void,
      ): Promise<any>;
      catch(
        type: errors.StatusCodeErrorConstructor,
        onrejected?: (reason: errors.StatusCodeError) => void,
      ): Promise<any>;
      catch(
        type: errors.TransformErrorConstructor,
        onrejected?: (reason: errors.TransformError) => void,
      ): Promise<any>;
      promise(): Promise<any>;
      cancel(): void;
    }
